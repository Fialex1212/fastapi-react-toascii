...
async def process_image_file(file: UploadFile, background_tasks: BackgroundTasks) -> str:
...
async def generate_ascii_file(image, filename: str, background_tasks: BackgroundTasks) -> str:
